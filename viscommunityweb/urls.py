...
urlpatterns = patterns('',
	...
	url(r'^taxonomy/api/taxonomyTree/(?P<formatting>\w+)', 'web.views.getTaxonomyTree', name='api_taxonomy_tree'),
	url(r'^taxonomy/api/taxonomyCategories', 'web.views.getTaxonomyCategories', name='api_taxonomy_categories'),
	url(r'^taxonomy/api/taxonomy/info/(?P<taxonomy_id>\d+)/$', 'web.views.getTaxonomyCategoryJSON', name='api_taxonomy_details'),
	url(r'^taxonomy/api/category/info/(?P<category_id>\d+)/$', 'web.views.getTaxonomyCategoryInformationJSON', name='api_taxonomy_category_details'),
