...
urlpatterns = patterns('',
                       ...
                       url(r'^reference/delete/(?P<taxonomy_id>\d+)/(?P<reference_id>\w+)/$',
                       ...
                       url(r'^reference/(?P<taxonomy_id>\d+)/(?P<reference_id>\w+)/$', 'web.views.reference_detail',
                       ...
                       url(r'^category/rename/(?P<category_id>\d+)/', 'web.views.renameTaxonomyCategoryAPI',
                           name='category_rename'),
                       url(r'^category/delete/(?P<category_id>\d+)/', 'web.views.deleteTaxonomyCategory',
                       ...
                       url(r'^api/taxonomyTree/(?P<formatting>\w+)', 'web.views.getTaxonomyTree',
                           name='api_taxonomy_tree'),
                       url(r'^api/taxonomyCategories', 'web.views.getTaxonomyCategories',
                           name='api_taxonomy_categories'),
                       url(r'^api/taxonomy/info/(?P<taxonomy_id>\d+)/$', 'web.views.getTaxonomyCategoryJSON',
                           name='api_taxonomy_details'),
